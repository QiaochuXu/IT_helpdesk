  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="app-container">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border style="width: 100%;">
        <el-table-column prop="checkName" header-align="center" align="center" label="REQUESTER" show-overflow-tooltip></el-table-column>
        <el-table-column prop="questions" header-align="center" align="center" label="SUBJECT" show-overflow-tooltip></el-table-column>
        <el-table-column prop="userName" header-align="center" align="center" label="AGENT" show-overflow-tooltip></el-table-column>
